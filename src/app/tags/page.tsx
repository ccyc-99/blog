...
export default function TagsPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 md:py-16">
      <div className="mb-12">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-200 mb-3 tracking-tight">
          标签分类
        </h1>
      ...
      {tags.length === 0 ? (
        <div className="text-center py-20">
          ...
          <p className="text-lg text-gray-500">暂无标签</p>
        </div>
      ) : (
          ...
          {tags.map(({ tag, count }, index) => (
            ...
            >
              ...
              <div className="relative">
                <span className="block text-gray-200 font-semibold group-hover:text-indigo-400 transition-colors duration-200">
                  {tag}
                </span>
